...
/* harmony import */ var _services_dropbox_s_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../services/dropbox-s.service */ "./src/services/dropbox-s.service.ts");
/* harmony import */ var watermarkjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! watermarkjs */ "./node_modules/watermarkjs/dist/watermark.js");
/* harmony import */ var watermarkjs__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(watermarkjs__WEBPACK_IMPORTED_MODULE_4__);
...
let Tab1Page = class Tab1Page {
    constructor(service, sanitizer, alertController) {
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            this.getBase64ImageFromUrl(this.actualPokemon.img)
                ...
                this.getBase64ImageFromUrl(imageUrl).then(upload => {
                    watermarkjs__WEBPACK_IMPORTED_MODULE_4__([upload], options)
                        .image(watermarkjs__WEBPACK_IMPORTED_MODULE_4__["text"].lowerRight(this.actualPokemon.name, '48px Josefin Slab', '#fff', 0.5))
                        .then(img => {
                        watermarkjs__WEBPACK_IMPORTED_MODULE_4__([img, this.resizeImage(result)], options)
                            .image(watermarkjs__WEBPACK_IMPORTED_MODULE_4__["image"].lowerLeft())
                            .then(img2 => {
...
Tab1Page.propDecorators = {
    waterMarkImage: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"], args: ['previewImage',] }]
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DropboxSService", function() { return DropboxSService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
let DropboxSService = class DropboxSService {
    constructor(http) {
        this.http = http;
    ...
    uploadFile(data) {
        ...
        console.log('entra2');
        return this.http.post('https://a1cards.com.co/kapta/pruebaJonathanUpload', nData, { observe: 'response' });
    }
    getPokemonInfo() {
...
DropboxSService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
DropboxSService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
//# sourceMappingURL=app-tab1-tab1-module-es2015.js.map