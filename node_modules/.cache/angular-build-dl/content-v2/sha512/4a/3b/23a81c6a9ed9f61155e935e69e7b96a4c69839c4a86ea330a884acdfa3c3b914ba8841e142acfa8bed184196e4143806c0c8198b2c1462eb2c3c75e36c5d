...
const routes = [
    {
        path: '',
        loadChildren: () => __webpack_require__.e(/*! import() | app-tab1-tab1-module */ "app-tab1-tab1-module").then(__webpack_require__.bind(null, /*! ../app/tab1/tab1.module */ "./src/app/tab1/tab1.module.ts")).then(m => m.Tab1PageModule)
    }
];
...
module.exports = __webpack_require__(/*! /Users/JonathanMoya/Documents/Entrevistas/Kapta/Watermark/src/main.ts */"./src/main.ts");
