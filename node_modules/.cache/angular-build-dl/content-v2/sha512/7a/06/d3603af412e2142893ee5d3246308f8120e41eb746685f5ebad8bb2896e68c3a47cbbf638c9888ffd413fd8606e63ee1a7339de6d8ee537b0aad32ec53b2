(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["app-tab1-tab1-module"], {
    /***/
    ...
    function node_modulesRawLoaderDistCjsJsSrcAppTab1Tab1PageHtml(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = "<ion-content [fullscreen]=\"true\">\n    <!--    <ion-input type=\"file\" accept=\"image/x-png,image/gif,image/jpeg\"></ion-input>-->\n    <div id=\"cargandoId\">\n        <p>Cargando</p>\n    </div>\n    <div class=\"container mt-2\">\n        <button type=\"button\" class=\"mt-2 btn btn-outline-primary btn-block\" (click)=\"takePicture()\">Tomar foto</button>\n        <button type=\"button\" class=\"mt-2 btn btn-outline-primary btn-block\" (click)=\"sendFile()\">Enviar imagen</button>\n        <div class=\"mt-2\" id=\"container\"></div>\n    </div>\n</ion-content>\n";
      /***/
    },
    ...
    /***/
    function node_modulesWatermarkjsDistWatermarkJs(module, exports, __webpack_require__) {
      (function webpackUniversalModuleDefinition(root, factory) {
        ...
        return (
          ...
          function (module, __webpack_exports__, __webpack_require__) {
            ...
            var canvas_pool = shared; // CONCATENATED MODULE: ./lib/index.js
    ...
    function srcAppTab1Tab1PageScss(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = "#cargandoId {\n  width: 100%;\n  height: 100%;\n  position: fixed;\n  background-color: rgba(0, 0, 0, 0.5);\n  z-index: 9999;\n}\n\n#cargandoId p {\n  top: 45vh;\n  left: 45vw;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    },
    ...
    function srcAppTab1Tab1PageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _services_dropbox_s_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ../../services/dropbox-s.service */
      "./src/services/dropbox-s.service.ts");
      /* harmony import */


      var watermarkjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! watermarkjs */
      "./node_modules/watermarkjs/dist/watermark.js");
      /* harmony import */


      var watermarkjs__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(watermarkjs__WEBPACK_IMPORTED_MODULE_4__);
      /* harmony import */
      ...
      var Tab1Page = /*#__PURE__*/function () {
        function Tab1Page(service, sanitizer, alertController) {
          var _this2 = this;
          ...
          this.blobImage = '';
          this.originalImage = '';
          this.newImage = ''; // this.takePhoto();

          this.service.getPokemonInfo().subscribe(function (res) {
            console.log(res);
            _this2.actualPokemon.name = res.name;
            _this2.actualPokemon.img = res.sprites.front_default;
        ...
        _createClass(Tab1Page, [{
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 2:
                      ...
                      console.log(image); // Can be set to the src of an image now

                      console.log(imageUrl);
                      this.getBase64ImageFromUrl(imageUrl).then(function (result) {
                        console.log(result);
                      });
                      options = {
                      ...
                      this.getBase64ImageFromUrl(this.actualPokemon.img).then(function (result) {
                        console.log(result);
                        console.log(_this3.resizeImage(result));

                        _this3.getBase64ImageFromUrl(imageUrl).then(function (upload) {
                          watermarkjs__WEBPACK_IMPORTED_MODULE_4__([upload], options).image(watermarkjs__WEBPACK_IMPORTED_MODULE_4__["text"].lowerRight(_this3.actualPokemon.name, '48px Josefin Slab', '#fff', 0.5)).then(function (img) {
                            watermarkjs__WEBPACK_IMPORTED_MODULE_4__([img, _this3.resizeImage(result)], options).image(watermarkjs__WEBPACK_IMPORTED_MODULE_4__["image"].lowerLeft()).then(function (img2) {
                              _this3.sanitizer.bypassSecurityTrustResourceUrl(img2.src);

                              document.getElementById('container').appendChild(img2);
                              _this3.newImage = img2.src;
                            });
                          });
                        });
                      })["catch"](function (err) {
          ...
          key: "resizeImage",
          value: function resizeImage(base64Str) {
            var img = new Image();
            img.src = base64Str;
          ...
          key: "renderPhoto",
          value: function renderPhoto() {// @ts-ignore
          }
        }, {
          key: "sendFile",
          value: function sendFile() {
            ...
            if (this.newImage !== '') {
              ...
              console.log('entra1');
              this.service.uploadFile(this.newImage).subscribe(function (res) {
                console.log(res);
                document.getElementById('cargandoId').style.display = 'none';
              }, function (err) {
                console.log(err);
          ...
          key: "presentAlertError2",
          value: function presentAlertError2() {
      ...
      Tab1Page.ctorParameters = function () {
        return [{
          type: _services_dropbox_s_service__WEBPACK_IMPORTED_MODULE_3__["DropboxSService"]
        }, {
    ...
    /*! exports provided: DropboxSService */

    /***/
    function srcServicesDropboxSServiceTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "DropboxSService", function () {
        return DropboxSService;
      });
      /* harmony import */
      ...
      var DropboxSService = /*#__PURE__*/function () {
        function DropboxSService(http) {
          _classCallCheck(this, DropboxSService);
        ...
        _createClass(DropboxSService, [{
          ...
          value: function uploadFile(data) {
            ...
            console.log('entra2');
            return this.http.post('https://a1cards.com.co/kapta/pruebaJonathanUpload', nData, {
              observe: 'response'
            });
          }
        }, {
          key: "getPokemonInfo",
          value: function getPokemonInfo() {
            return this.http.get('https://pokeapi.co/api/v2/pokemon/1/');
          }
        }, {
          key: "login",
          value: function login() {
            return this.http.get('https://a1cards.com.co/kapta/pruebaJonathan');
          }
        }]);
      ...
      DropboxSService.ctorParameters = function () {
        return [{
          type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
        }];
      };

      DropboxSService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], DropboxSService);
      /***/
    }
...
//# sourceMappingURL=app-tab1-tab1-module-es5.js.map